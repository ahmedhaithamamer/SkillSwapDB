...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top" style="background-color: rgba(255, 255, 255, 0.9); backdrop-filter: blur(10px);">
        <div class="container">
            <a class="navbar-brand fw-bold" href="<?php echo 'http://localhost:8888/skill_swap/HomePage/home.php'; ?>">SkillSwap</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo 'http://localhost:8888/skill_swap/HomePage/home.php'; ?>">Home</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body p-4">
                            ...
                            <div class="text-center mt-3">
                                <p>Don't have an account? <a href="<?php echo 'http://localhost:8888/skill_swap/register/register.php'; ?>">Sign up</a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="http://localhost:8888/skill_swap/register/login.php" class="text-white">Login</a></li>
                        <li><a href="http://localhost:8888/skill_swap/register/register.php" class="text-white">Sign Up</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <h5>Contact</h5>
