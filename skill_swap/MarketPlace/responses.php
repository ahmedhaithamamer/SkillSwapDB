    ...
    <div class="content-wrapper">
        <div class="container py-5">
            <div class="request-container">
                ...
                <!-- Back button -->
                <div class="mb-4">
                    <a href="http://localhost:8888/skill_swap/Marketplace/marketplace.php" class="btn btn-outline-secondary">
                        <i class="bi bi-arrow-left"></i> Back to The Marketplace
                    </a>
                </div>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form method="POST" action="http://localhost:8888/skill_swap/MarketPlace/add_response.php?id=<?php echo $request_id; ?>">
                            <div class="mb-3">
